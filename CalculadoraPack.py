...
ventanaC = tk.Tk()
ventanaC.title("Calculadora")
ventanaC.geometry('200x300')

cajaMantisa = tk.Entry(ventanaC)
cajaMantisa.pack(ipady=10, side=tk.TOP)
btnmen = tk.Button(ventanaC, text= "===")
...
btnPorciento.pack(side=tk.LEFT, ipadx=8,ipady=2)
btnRaiz = tk.Button(panel1, text= "  CE  ")
btnRaiz.pack(side=tk.LEFT, ipadx=8,ipady=2)
btnPtencia = tk.Button(panel1, text= " C ")
btnPtencia.pack(side=tk.LEFT, ipadx=8,ipady=2)
btnResiproco = tk.Button(panel1, text= "  <X|  ")
btnResiproco.pack(side=tk.LEFT, ipadx=8,ipady=2)
...
btnIgual.pack(side=tk.LEFT, ipadx=8,ipady=2)
btnPunto = tk.Button(panel2, text= "  x^2  ")
btnPunto.pack(side=tk.LEFT, ipadx=8,ipady=2)
btn0 = tk.Button(panel2, text= "  SQRT  ")
btn0.pack(side=tk.LEFT, ipadx=8,ipady=2)
btnMM = tk.Button(panel2, text= "  /  ")
btnMM.pack(side=tk.LEFT, ipadx=8,ipady=2)

##===================
panel3= tk.Frame(ventanaC, bg='cyan',width=350,height=50)
panel3.pack()
btn1 = tk.Button(panel3, text= "  7  ")
btn1.pack(side=tk.LEFT, ipadx=10,ipady=2)
btn2 = tk.Button(panel3, text= "  8  ")
btn2.pack(side=tk.LEFT, ipadx=10,ipady=2)
btn3 = tk.Button(panel3, text= "  9  ")
btn3.pack(side=tk.LEFT, ipadx=10,ipady=2)
btnMas = tk.Button(panel3, text= "  X  ")
btnMas.pack(side=tk.LEFT, ipadx=10,ipady=2)
